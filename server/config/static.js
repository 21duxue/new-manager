...
module.exports=function (router, options){
  ...
  router.all(/((\.jpg)|(\.png)|(\.gif))$/i, static('./public', {
    maxage: options.image*86400*1000
  }));
  router.all(/((\.js)|(\.jsx))$/i, static('./public', {
    maxage: options.script*86400*1000
  }));
  router.all(/(\.css)$/i, static('./public', {
    maxage: options.styles*86400*1000
  }));
  router.all(/((\.html)|(\.htm))$/i, static('./public', {
    maxage: options.html*86400*1000
  }));
  router.all('*', static('./public', {
